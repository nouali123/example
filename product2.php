    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card bg-light mb-3">
                <div class="card-body">
				 <font size="8" face="georgia" color="black"> <p align="center" class="price">Confiture </p> </font>
				<h2> <font size="3" face="georgia" color="red"> <p align="center" class="price">25dhs/200g </p><h2>
                   <p align="center" class="price">50dhs/400g </p>
				   <p align="center" class="price">125dhs/kg </p>
				   </font>
                    ...
                    <form action="ins2.php" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
							 ...
							 <button type="submit" value="submit" class="btn btn-success btn-lg btn-block text-uppercase"  ><i class="fa fa-shopping-cart"></i> Acheter</button>
